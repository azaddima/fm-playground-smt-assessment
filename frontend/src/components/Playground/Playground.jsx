...
const Playground = ({editorValue, setEditorValue, language, setLanguage}) => {
    ...
    useEffect(() => {
        ...
        if (currentTask === "9" || currentTask === "10") {
            console.log("hi")
        } else {
                ...
                <div className="row">
                    ...
                    {currentTask === "8" &&
                        <div className="row mt-5 mb-5 ">
                            <h4>Original Tree</h4>
                            <img className="" src="original_decision_tree.png"/>
                            <h4 className="mt-5">Pruned Tree</h4>
                            <img className="" src="pruned_decision_tree.png"/>
                        </div>
                    }
                    ...
                    <div className='col-md-6' style={{backgroundColor: 'white'}}>
                        <div className='row'>
                            <div className='col-md-12'>
                                <div
                                    className={`d-flex justify-content-between ${language.id !== 'xmv' ? 'mb-3' : ''}`}>
                                    <h2>Output</h2>
                                </div>
                            </div>
                            <div className='col-md-12'>
